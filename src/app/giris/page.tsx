...
export default function GirisYap() {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-[#f7f9fb] py-12 px-4">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md mb-20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            // Buraya telefon ile giriş fonksiyonu eklenebilir
          >
            Telefon numarası ile giriş yap
          </button>
          <button
            type="submit"
            className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 rounded transition mt-4 text-lg"
          >
            Giriş yap
          </button>
          ...
          <div className="flex flex-row gap-3">
            ...
            >
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                <path d="M16.365 1.43c0 1.14-.93 2.07-2.07 2.07-.06 0-.12 0-.18-.01.01-.13.02-.26.02-.39 0-1.14.93-2.07 2.07-2.07.06 0 .12 0 .18.01-.01.13-.02.26-.02.39z"/>
              </svg>
